func.func @test_simple_argmax_dispatch_0_arg_compare_4x1x1336xf16() attributes {translation_info = #iree_codegen.translation_info<pipeline = LLVMGPUDistribute workgroup_size = [128, 1, 1] subgroup_size = 64>} {
  ...
  %11:2 = scf.forall (%arg0) = (0) to (128256) step (1336) shared_outs(%arg1 = %6, %arg2 = %5) -> (tensor<4x1x96xf16>, tensor<4x1x96xi32>) {
    ...
    ^bb0(%arg3: f16, %arg4: f16):
      %22 = arith.cmpf ogt, %arg3, %arg4 : f16
      iree_linalg_ext.yield %22 : i1
    } -> tensor<4x1xf16>, tensor<4x1xi32>
    %21:2 = scf.forall (%arg3, %arg4) = (0, 0) to (4, 1) step (1, 128) shared_outs(%arg5 = %extracted_slice_0, %arg6 = %extracted_slice_3) -> (tensor<4x1xf16>, tensor<4x1xi32>) {
      %c1 = arith.constant 1 : index
      %22 = affine.min affine_map<(d0) -> (-d0 + 1, 128)>(%arg4)
      %extracted_slice_4 = tensor.extract_slice %18[%arg3, %arg4, 0] [1, %22, 1336] [1, 1, 1] : tensor<4x1x1336xf16> to tensor<1x?x1336xf16>
      %extracted_slice_5 = tensor.extract_slice %arg5[%arg3, %arg4] [1, %22] [1, 1] : tensor<4x1xf16> to tensor<1x?xf16>
      %extracted_slice_6 = tensor.extract_slice %arg6[%arg3, %arg4] [1, %22] [1, 1] : tensor<4x1xi32> to tensor<1x?xi32>
      %23:2 = iree_linalg_ext.arg_compare {lowering_config = #iree_codegen.lowering_config<tile_sizes = [[1, 128]]>} dimension(2) ins(%extracted_slice_4 : tensor<1x?x1336xf16>) outs(%extracted_slice_5, %extracted_slice_6 : tensor<1x?xf16>, tensor<1x?xi32>) index_base(%19 : index) {
      ^bb0(%arg7: f16, %arg8: f16):
        %24 = arith.cmpf ogt, %arg7, %arg8 : f16
        iree_linalg_ext.yield %24 : i1
      } -> tensor<1x?xf16>, tensor<1x?xi32>
      scf.forall.in_parallel {
        tensor.parallel_insert_slice %23#0 into %arg5[%arg3, %arg4] [1, %22] [1, 1] : tensor<1x?xf16> into tensor<4x1xf16>
        tensor.parallel_insert_slice %23#1 into %arg6[%arg3, %arg4] [1, %22] [1, 1] : tensor<1x?xi32> into tensor<4x1xi32>
      }
