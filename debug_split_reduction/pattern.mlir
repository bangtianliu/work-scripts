  ...
  func.func @test_simple_argmax_dispatch_0_arg_compare_4x1x1336xf16() attributes {translation_info = #translation} {
    ...
    %11:2 = scf.forall (%arg0) = (0) to (128256) step (1336) shared_outs(%arg1 = %6, %arg2 = %5) -> (tensor<4x1x96xf16>, tensor<4x1x96xi32>) {
      ...
      %20:2 = scf.forall (%arg3, %arg4) = (0, 0) to (4, 1) step (1, 128) shared_outs(%arg5 = %extracted_slice_0, %arg6 = %extracted_slice_3) -> (tensor<4x1xf16>, tensor<4x1xi32>) {
        ...
        %21 = tensor.empty() : tensor<1x1xf16>
        %22 = linalg.fill {lowering_config = #config} ins(%cst : f16) outs(%21 : tensor<1x1xf16>) -> tensor<1x1xf16>
        %extracted_slice_5 = tensor.extract_slice %arg1[%arg3, 0, %17] [1, 1, 1] [1, 1, 1] : tensor<4x1x96xf16> to tensor<1x1x1xf16>
        %broadcasted_6 = linalg.broadcast ins(%22 : tensor<1x1xf16>) outs(%extracted_slice_5 : tensor<1x1x1xf16>) dimensions = [2]  {lowering_config = #config}
        %extracted_slice_7 = tensor.extract_slice %broadcasted_6[0, 0, 0] [1, 1, 1] [1, 1, 1] : tensor<1x1x1xf16> to tensor<1x1xf16>
        %23 = tensor.empty() : tensor<1x1xi32>
        %24 = linalg.fill {lowering_config = #config} ins(%c0_i32 : i32) outs(%23 : tensor<1x1xi32>) -> tensor<1x1xi32>
        %extracted_slice_8 = tensor.extract_slice %arg2[%arg3, 0, %17] [1, 1, 1] [1, 1, 1] : tensor<4x1x96xi32> to tensor<1x1x1xi32>
        %broadcasted_9 = linalg.broadcast ins(%24 : tensor<1x1xi32>) outs(%extracted_slice_8 : tensor<1x1x1xi32>) dimensions = [2]  {lowering_config = #config}
        %extracted_slice_10 = tensor.extract_slice %broadcasted_9[0, 0, 0] [1, 1, 1] [1, 1, 1] : tensor<1x1x1xi32> to tensor<1x1xi32>
        %25:2 = iree_linalg_ext.arg_compare {lowering_config = #config} dimension(2) ins(%extracted_slice_4 : tensor<1x1x1336xf16>) outs(%extracted_slice_7, %extracted_slice_10 : tensor<1x1xf16>, tensor<1x1xi32>) index_base(%19 : index) {
        ^bb0(%arg7: f16, %arg8: f16):
          %26 = arith.cmpf ogt, %arg7, %arg8 : f16
          iree_linalg_ext.yield %26 : i1
        } -> tensor<1x1xf16>, tensor<1x1xi32>
        %cast = tensor.cast %25#0 : tensor<1x1xf16> to tensor<1x?xf16>
        %cast_11 = tensor.cast %25#1 : tensor<1x1xi32> to tensor<1x?xi32>
        scf.forall.in_parallel {
          tensor.parallel_insert_slice %cast into %arg5[%arg3, %c0] [1, %c1] [1, 1] : tensor<1x?xf16> into tensor<4x1xf16>
          tensor.parallel_insert_slice %cast_11 into %arg6[%arg3, %c0] [1, %c1] [1, 1] : tensor<1x?xi32> into tensor<4x1xi32>
        }
